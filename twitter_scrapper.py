...
for k in keywords:
    ...
    tweets = [{'Tweet':tweet.text, 'User':tweet.user.screen_name, 'Location':tweet.user.location,'Likes':tweet.favorite_count, 'Retweets':tweets.retweet_count ,'Timestamp':tweet.created_at, 'Geocode':tweet.geo} for tweet in query]
